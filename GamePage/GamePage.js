...
function alignGamePage() {
    ...
    simonTitle.style.left =  (parseFloat(simonGameSTYLE.width) - (parseFloat(simonImgSTYLE.left) + parseFloat(simonImgSTYLE.width)))/2 - parseFloat(simonImgSTYLE.width) + "px";
