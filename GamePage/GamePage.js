...
function alignGamePage() {
    ...
    simonTitle.style.left =
        parseFloat(simonImgSTYLE.left) +
        parseFloat(simonImgSTYLE.width) +
        (parseFloat(simonGameSTYLE.width) -
            (parseFloat(simonImgSTYLE.left) +
                parseFloat(simonImgSTYLE.width))) /
            2 -
        parseFloat(simonTitleSTYLE.width) / 2 +
        "px";
    simonTitle.style.top =
        (parseFloat(simonGameSTYLE.height) -
            (parseFloat(simonTitleSTYLE.height) +
                parseFloat(simonBlurbSTYLE.height) +
                25 -
                10)) /
            2 +
        "px";

    simonBlurb.style.width =
        parseFloat(simonGameSTYLE.width) -
        (parseFloat(simonImgSTYLE.left) * 2 + parseFloat(simonImgSTYLE.width));
    simonBlurb.style.left =
        parseFloat(simonImgSTYLE.left) * 2 +
        parseFloat(simonImgSTYLE.width) +
        (parseFloat(simonGameSTYLE.width) -
            (parseFloat(simonImgSTYLE.left) +
                parseFloat(simonImgSTYLE.width))) /
            2 -
        parseFloat(simonBlurbSTYLE.width) / 2 +
        "px";
    simonBlurb.style.top =
        (parseFloat(simonGameSTYLE.height) -
            (parseFloat(simonTitleSTYLE.height) +
                parseFloat(simonBlurbSTYLE.height) +
                25)) /
    ...
    simonPlay.style.left =
        ...
        (parseFloat(simonGameSTYLE.width) -
            (parseFloat(simonImgSTYLE.left) +
                parseFloat(simonImgSTYLE.width))) /
            2 -
        parseFloat(simonPlaySTYLE.width) / 2 +
        "px";
    simonPlay.style.top =
        (parseFloat(simonGameSTYLE.height) -
            (parseFloat(simonTitleSTYLE.height) +
    ...
    colorTitle.style.right =
        parseFloat(colorImgSTYLE.right) +
        parseFloat(colorImgSTYLE.width) +
        (parseFloat(colorGameSTYLE.width) -
            (parseFloat(colorImgSTYLE.right) +
                parseFloat(colorImgSTYLE.width))) /
            2 -
        parseFloat(colorTitleSTYLE.width) / 2 +
        "px";
    colorTitle.style.top =
        (parseFloat(colorGameSTYLE.height) -
            (parseFloat(colorTitleSTYLE.height) +
                parseFloat(colorBlurbSTYLE.height) +
                25 -
                10)) /
            2 +
        "px";

    colorBlurb.style.width =
        parseFloat(colorGameSTYLE.width) -
        (parseFloat(colorImgSTYLE.right) * 2 + parseFloat(colorImgSTYLE.width));
    colorBlurb.style.right =
        parseFloat(colorImgSTYLE.right) * 2 +
        parseFloat(colorImgSTYLE.width) +
        (parseFloat(colorGameSTYLE.width) -
            (parseFloat(colorImgSTYLE.right) +
                parseFloat(colorImgSTYLE.width))) /
            2 -
        parseFloat(colorBlurbSTYLE.width) / 2 +
        "px";
    colorBlurb.style.top =
        (parseFloat(colorGameSTYLE.height) -
            (parseFloat(colorTitleSTYLE.height) +
                parseFloat(colorBlurbSTYLE.height) +
                25)) /
    ...
    colorPlay.style.right =
        ...
        (parseFloat(colorGameSTYLE.width) -
            (parseFloat(colorImgSTYLE.right) +
                parseFloat(colorImgSTYLE.width))) /
            2 -
        parseFloat(colorPlaySTYLE.width) / 2 +
        "px";
    colorPlay.style.top =
        (parseFloat(colorGameSTYLE.height) -
            (parseFloat(colorTitleSTYLE.height) +
